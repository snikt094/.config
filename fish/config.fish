if status is-interactive
    ...
    alias od="cd (find ~ -type d | fzf)" # Find a directory
    alias odu="cd (find ~/Documents/University -type d | fzf)" # Find a directory in for university
    ...
    abbr -a ff --position anywhere "(find ~ -type f -not -path '*/.*' |fzf)" #Find a file 
    abbr -a ffs --position anywhere "(find ~ -type f |fzf)" #Find a file unsafe 
